# MMRECP01 transparent recipe format
...
cargo run --release --features recipe-tool --bin marios-mask-recipe -- \
  verify <sm64.z64> <decompressed-mm.z64> recipe/marios-mask.mmrecipe
```

The report gives the transitive MM, SM64, and literal byte totals, the number of
