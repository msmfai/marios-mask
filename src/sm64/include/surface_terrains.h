...
// Clock Town extension: COL_TRI_INIT_N sets this flag on the surface type;
// each tri then carries an explicit stored normal (3 extra s16s, /32767),
// MM-style, instead of deriving the normal from vertex winding.
#define TERRAIN_HAS_NORMALS 0x4000
...
// Explicit-normal variants (see TERRAIN_HAS_NORMALS)
#define COL_TRI_INIT_N(surfType, triNum) ((surfType) | TERRAIN_HAS_NORMALS), triNum
#define COL_TRI_N(v1, v2, v3, nx, ny, nz) v1, v2, v3, nx, ny, nz
